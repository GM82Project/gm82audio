...
#define audio_play
    ...
    var __call;__call=__gm82audio_sfx_play(argument0,__gm82audio_get_def_vol(argument0),__gm82audio_get_def_pan(argument0),__gm82audio_get_def_pitch(argument0),0)
...
#define audio_loop
    ///audio_loop(sound)
    //sound: sound index to play looped
    //returns: instance id
    //Plays a sound looped and returns an instance id.
    if (audio_preload_sound(argument0)) exit
    var __call;__call=__gm82audio_sfx_play(argument0,__gm82audio_get_def_vol(argument0),__gm82audio_get_def_pan(argument0),__gm82audio_get_def_pitch(argument0),1)
    __gm82audio_check(__call,"audio_loop",argument0)
    return __call


#define audio_loop_single
    ///audio_loop_single(sound)
    //sound: sound index to play looped
    //returns: instance id
    //Plays a single instance of the sound looped and returns an instance id.
    audio_stop(argument0)
    return audio_loop(argument0)
...
#define audio_music_play
    ...
    __gm82audio_check(__gm82audio_music_play(
        argument[0],__fade,__gm82audio_get_def_vol(argument0),__gm82audio_get_def_pan(argument0),__gm82audio_get_def_pitch(argument0),1
...
#define audio_music_crossfade
    ...
    __gm82audio_check(__gm82audio_music_crossfade(
        argument0,argument1,__gm82audio_get_def_vol(argument0),__gm82audio_get_def_pan(argument0),__gm82audio_get_def_pitch(argument0),1
...
#define audio_music_switch
    ...
    __gm82audio_check(__gm82audio_music_switch(
        argument[0],argument[1],__fadein,__gm82audio_get_def_vol(argument0),__gm82audio_get_def_pan(argument0),__gm82audio_get_def_pitch(argument0),1
